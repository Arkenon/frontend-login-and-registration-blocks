...
const Options = ({options}) => {
	...
	return (
		<InspectorControls>
			...
			<Panel>
				<PanelBody title={__('Description Settings', 'frontend-login-and-registration-blocks')} initialOpen={false}>
					<PanelRow>
						<ToggleControl
							label={__('Show Description', 'frontend-login-and-registration-blocks')}
							help={
