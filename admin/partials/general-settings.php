	...
	<table id="flr-blocks-admin-general-settings" class="form-table">
		...
		<tr>
			<th scope="row">
				...
				<label for="flr_blocks_has_activation">
					<?php echo esc_html_x( "Enable user activation", "has_activation", "flr-blocks" ); ?>
				</label>

				<p class="flr-blocks-admin-settings-description">
					<?php echo esc_html_x( "If you want to send an activation code to your users, select 'Yes'.", "has_activation_description", "flr-blocks" ); ?>
				</p>
		...
		<tr>
			<th scope="row">
				...
				<label for="flr_blocks_has_user_dashboard">
					<?php echo esc_html_x( "Enable user settings", "has_user_settings", "flr-blocks" ); ?>
				</label>

				<p class="flr-blocks-admin-settings-description">
					<?php echo esc_html_x( "If you want to show a user settings page, select Yes. (Don't forget to select a User Settings page below)", "has_user_settings_description", "flr-blocks" ); ?>
				</p>
		...
		<tr>
			<th scope="row">
				...
				<label for="flr_blocks_redirect_from_wp_login_admin">
					<?php echo esc_html_x( "Hide wp-login&wp-admin", "hide_wp_login_admin", "flr-blocks" ); ?>
				</label>

				<p class="flr-blocks-admin-settings-description">
					<?php echo esc_html_x( "If you choose 'Yes', users who are not logged in will be redirected to the home page.", "hide_wp_login_admin_description", "flr-blocks" ); ?>
				</p>
		...
		$selections = [
				[
						...
						"title"    => _x( "Login Page", "login_page", "flr-blocks" ),
						"description"    => _x( "Select a page if created a login page.", "login_page_description", "flr-blocks" ),
				],
				[
						'option'      => 'flr_blocks_redirect_after_login',
						"title"    => _x( "Redirection Page After Login", "redirect_page_after_login", "flr-blocks" ),
						"description"    => _x( "Select a page if you want to redirect users to a specific page after login.", "redirect_page_after_login_description", "flr-blocks" ),
				],
				[
						'option' => 'flr_blocks_lost_password_page',
						"title"    => _x( "Lost (Reset) Password Page", "lost_password_page", "flr-blocks" ),
				],
				[
						'option' => 'flr_blocks_register_page',
						"title"    => _x( "Registration Page", "registration_page", "flr-blocks" ),
				],
				[
						'option'      => 'flr_blocks_activation_page',
						"title"    => _x( "User Activation Page", "activation_page", "flr-blocks" ),
						"description"    => _x( "Select a page if you selected 'Yes' in the 'Enable user activation' setting", "activation_page_description", "flr-blocks" ),
				],
				[
						'option'      => 'flr_blocks_user_settings_page',
						"title"    => _x( "User Settings Page", "user_settings_page", "flr-blocks" ),
						"description"    => _x( "Select a page if you selected 'Yes' in the 'Enable user settings' setting", "user_settings_page_description", "flr-blocks" ),
				],
				[
						'option' => 'flr_blocks_terms_and_conditions_page',
						"title"    => _x( "Terms and Conditions Page", "terms_and_conditions_page", "flr-blocks" ),
				],
				[
						'option' => 'flr_blocks_privacy_policy_page',
						"title"    => _x( "Privacy Policy Page", "privacy_policy_page", "flr-blocks" ),
				]
		];
