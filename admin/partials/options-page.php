...
if ( ! current_user_can( "administrator" ) ) {
	...
	wp_die( esc_html__( "You are not authorized to see this page.", "frontend-login-and-registration-blocks" ) );
	...
	<nav class="nav-tab-wrapper">
		...
		<a href="?page=frontend-login-with-gutenberg-blocks-settings"
		   class="nav-tab <?php if ( empty( $tab ) ): ?>nav-tab-active<?php endif; ?>">
			<?php echo esc_html_x( "General Settings", "admin_general_settings", "frontend-login-and-registration-blocks" ); ?>
		</a>
		...
		<a href="?page=frontend-login-with-gutenberg-blocks-settings&tab=mail-templates"
		   class="nav-tab <?php if ( $tab === 'mail-templates' ): ?>nav-tab-active<?php endif; ?>">
			<?php echo esc_html_x( "E-Mail Templates", "admin_mail_settings", "frontend-login-and-registration-blocks" ); ?>
		</a>
